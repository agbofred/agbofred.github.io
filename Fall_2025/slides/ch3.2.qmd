...
```{.Python code-line-numbers="1|2|3-6|7-8|9-10|11-12|13|14-17|18" style="height:700px;"}
...
- All the disks start out on one rod, stacked in order of diameter, which gives the
