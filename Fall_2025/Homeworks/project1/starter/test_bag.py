# test_bag.py will test all the behaviors of the bag class and return a message "All tests passed!" if successful
# Do nothing to this file but just running it to see if everything works.
