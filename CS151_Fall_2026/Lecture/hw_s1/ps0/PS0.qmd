---
title: "Problem Set 0"
subtitle: "Due but not graded: August 26, 2026 at 10:00 PM"
format:
  html:
    theme:
      light: 
...
```{=html}
<a href='https://classroom50.org/Agbo-CS151/cs151-fa-2026/assignments/ps0/accept' target="_blank" class="btn btn-info" style='margin:auto; display: block; width:50%;'>Accept Assignment</a>
```
<br>
