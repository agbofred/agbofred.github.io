...
:::{.callout-important}
You do not necessarily need to _center_ the paddle on the mouse here (though it does make it more intuitive to play the game). But the most common deduction if for letting the paddle extend beyond the borders of the window when the mouse is close to the edges of the window. So ensure you are not letting that happen!
:::
