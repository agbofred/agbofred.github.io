...
:::{.callout-warning}
A common stumbling block is that students will create a single rectangle and then try to add it to multiple parts of the window. This might seem like it works initially, but really it is just opening you up to a ton of pain later. Remember the felt-board or bulletin-board model for how PGL works! You must create a new shape for each thing you want to "add" to the window. Imagine it as if you were cutting it out of another piece of paper.
:::
