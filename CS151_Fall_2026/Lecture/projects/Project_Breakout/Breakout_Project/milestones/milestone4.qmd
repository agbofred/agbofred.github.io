...
- You have to give the user three chances to remove the bricks. When the ball falls through the bottom of the window, you should move the ball back to the center of the screen, recompute initial velocities just as you did at the beginning, and then wait for a click to start the ball moving. If the user has already had three chances, the game is over, and you should not recenter the ball.
