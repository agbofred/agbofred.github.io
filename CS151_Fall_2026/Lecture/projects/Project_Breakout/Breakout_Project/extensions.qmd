...
This project is perfect for those of you who are looking for a $+$ or (dare I say it) $++$ score, because there are so many possible extensions. Here are a few ideas to get you thinking, but this list is by no means exhaustive!
  ...
  - _Add in a difficulty curve:_ The arcade version of Breakout lured you in by starting off slowly. But, as soon as you thought you were getting the hang of things, the program sped up, making life just a bit more exciting. Note that if you start making the ball travel too fast here, your collision detection can start to struggle,
