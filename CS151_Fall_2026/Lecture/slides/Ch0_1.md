...
- Things to do:
	...
	- Class communication/announcements: on Canvas & ***Discord Server***. [Link TBD](#) later!
	- Fill out the section availability form [here](https://forms.gle/6iPrCHwMaUA1jTXQ7). Last day to fill it out is Thursday this week.
...
- Watch the vidoes prepared by __Professor Jed__ under ***Course Guide*** on Canvas and follow the instructions to:
	...
	- learn how to use ***Classroom 50*** (formerlly __GitHub Classroom__) for the homework in this class 
		- As time permits, I'll show how this tool works, similar to Github Classroom.
...
- Take a moment to pause and think
	- Envision yourself at the end of this semester, a capable, if perhaps slow, programmer
		- What is one tool or program that you might create that would be useful to you or someone else?
...
## Motivations
:::incremental
- __Fifty years ago:__ Mainframes filled rooms and had tiny processing power.
- __Today__: Pocket-sized phones run complex AI models and connect to global data instantly.
- __The shift__: Hardware is smaller, software is smarter, and access is global.
- The Speed of Growth
	- New tools emerge every week.
	- AI and automation push limits past old boundaries.
	- Change happens faster now than at any point in history.
- Why Study It Now?
	- You build the tools that run the world.
	- You help solve hard problems in medicine, art, and science.
	- You guide how humans use powerful new technology.
:::
...
- Fill out this short survey on your goals using this [link](https://www.polleverywhere.com/agbofred203)
...
- Polling website at this [link](https://www.polleverywhere.com/agbofred203). Remains constant throughout the semester.


---

## Perusall
- 1-2 short content videos by __Professor Jed__ will be posted 2 days before each class
	- Around 10 min each
- The expectation is that you have watched those videos and thought about that content _before_ arriving to class
	- We'll be going over the lecture briefly then jump to demonstrating the content, not introducing the content
- A Perusall assignment is due before class starts each day, so ensure you have watched and interacted with these content videos
...
- Submissions of _both_ will be handled through __Classroom 50__
	- Learn how to use GitHub for this class from Jed's __videos__ which is the same as using __Classroom 50__. 
...
## Sections
:::{.incremental style="font-size: 45px;"}
- Everyone will be placed into small sections of approx. 10-12 students, with one section leader
...
- Will meet as a group with your section leader once a week for an hour to go over and work on problems/projects
	- These meetings will be on Wednesdays or Thursdays and __it is mandatory__
	- You can have 3 excused absences throughout the semester. Contact section leader prior when you will be absent.
		- beyond 3 absences (excused or not) will cause you 5% deduction from your cumulative grade
	- [Here is the form](https://forms.gle/6iPrCHwMaUA1jTXQ7) where you can enter in __ALL__ your availability on these days.
		- Fill out the form latest on Thursday night this week to get people placed into sections
- Section leaders will serve as your major support! Ask for help or guidance from them weekly
- **Prof. Jed** is in charge of the sections and he is planning to start section meetings _next_ week
:::
...
- Just two midterm this semester and one final:
	- Midterm 1 on Oct 2nd (in-class, more info to come)
	- Midterm 2 on Nov 6th (in-class, more info to come)
	- Final:
		- 9:10 – 10:10 M/W/F -> Tuesday December 8th (8:am - 11am)
		 - See this [calendar](https://my.willamette.edu/site/registrar/info/mywu-summative-evaluations) to confirm your exact date. (Finals are in-class, use of computer, partially open)
...
- Practice questions and study materials will be given out in advance.
...
## GitHub/Classroom 50 Demonstration
