...
- Join the class group. The code is `qUhTrP`

::::
::::::cols

::::col
![](../images/group_arranegment.png){width=60%}
::::
::::col
![](../images/code.png){width=60%}
::::
::::::
...
- Welcome to TechByte event tomorrow Tuesday _September 1_ __by 12 pm @ Ford 102__. 
...
- You already got the repository of worlds for today's problems [here](https://github.com/rembold-cs151-master/Lec3Content)
