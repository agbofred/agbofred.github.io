...
def test_arraysortedbag():
    ...
    # Test 14: Testing duplicate handling
    print("\n14. Testing duplicates:")
    bag_dup = ArraySortedBag([5, 3, 5, 1, 3, 5])
    print(f"   Bag with duplicates: {bag_dup}")
    print(f"   Count of 5: {bag_dup.count(5)}")
