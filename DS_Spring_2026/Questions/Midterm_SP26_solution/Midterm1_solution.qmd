...
32. Which region of the Python Virtual Machine (PVM) is responsible for managing computer memory in support of  function calls?  
    A. Object heap  
    B. **Call stack** 
    C. Unused memory
    D. Program bytecode 
...
11. During the infix-to-postfix conversion process, what types of items are stored on the stack?
    ...
    **Answer:** It holds operators and left parentheses.
...
12. When converting infix to postfix, what happens to the left parenthesis once its matching right parenthesis is processed?
    ...
    **Answer:** The left parenthesis is discarded.
