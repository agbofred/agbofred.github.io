...
list_time = time.time() - start_time
print(f"List (sum/len): {list_time:.4f} seconds")

# NumPy array
start_time = time.time()
np_mean = np.mean(np_array)
np_time = time.time() - start_time
print(f"NumPy mean(): {np_time:.4f} seconds")
print(f"Speedup: {list_time/np_time:.2f}x faster\n")

print("=" * 60)
print("Summary: NumPy is significantly faster for numerical operations!")
print("=" * 60)