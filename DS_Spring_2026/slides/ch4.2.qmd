...
- First Mini-project (MP1) is due today at 10pm 
  ...
  - ![](../images/scrp_poster.png){width="33%" style="background-color:white;"}
-----
...
::: {.non-stretch-slide style="font-size: 35px;"}
...
my_matrix(0,:) = 10 # adding 10 to all row 0
my_matrix(:,2) = 20 # adding 20 to all column 2
print(f"Matrix:\n{my_matrix}")
