...
## Announcements
- Welcome to CS152: Data Structures
- Things to do:
    - Access the course webpage on Canvas.
    - Read over the full syllabus carefully.
    - Join the class communication/announcements channel on  ***Discord Server***.!
    - Use the instruction on the __Resources__ menu on Canvas week 1 module to setup your environments
...
**Name:** Sam Holmes <br>
**Email:** srholmes at willamette.edu  <br>

:::
::: {.column width="30%"}
![](../images/samHolmes.jpg){width=50%}
:::
:::
...
- Contact the Bookstore for help and possible discount.
...
![](../images/syllabus.png){width=100%}

- Checkout the full mapping from the [PDF version of course syllabus](https://willamette.instructure.com/courses/9710/assignments/syllabus) 
...
- Weekly Reading, Class Attendance, and Participation in Class Activities - `40%`.
    - This is a huge part of the course grade.
        - Plan to be in-person in class and do not miss any inclass activities.
        - Grade is determined at the end of the semester (after finals).
...
## Homework
- All homework will be due on Wednesdays at 10:00pm.
...
- Extensions for any reason must be requested and approved by myself before the due date.
    - Maximum extention possible is 24 hrs.

## More on course structure and policy

- Check the syllabus:
    - [On canvas](https://willamette.instructure.com/courses/9710/assignments/syllabus)
    - [PDF version](https://willamette.instructure.com/courses/9710/files/folder/Course%20Material?preview=2522121)
- Pay a close attention to the course policy. 
    - For example, the use of AI tools or GenAI in this class.

## Getting to know you...
:::{.incremental}
- Tell us your name
- Share a fun fact about yourself or your favorite hobby outside of CS.
- What's one thing you hope to learn or build in this class?
- What do you reasonably expect to remember from your courses in 20 years?
- If you could only use one data structure for the rest of your life, which would it be? (You can guess!)
- Python, Java, C++, or something else—what's your favorite language and why?
...
- Programming paradigm refers to styles or approaches to programming, each with its own philosophy and techniques for organizing code. 
...
- Each paradigm offers unique strengths. 
- Python lets you mix and match these styles, so you can write code that is clear, maintainable, and efficient for your needs.

## Homework & Reading Chapters Reminder
- Complete PS0 to familiarize yourself with the GitHub Classroom assignment process
    - It attracts class activity and participation score. 
