from week16.model import GraphDemoModel
from week16.algorithms import shortestPaths, spanTree, topoSort
    ...
    def run(self):
        ...
        while True:
            ...
            self.model.run(shortestPaths))
                ...
                print("Sort:",
                " ".join(map(str,
                    self.model.run(topoSort))))
            else: break
    def getCommand(self, high, menu):   ### Implemented in Cahpter 8 (Queue) Page 235 (Case study: Emmergency room schedular)
