...
```{=html}
<a href='https://classroom.github.com/a/MTbhCjMY' target="_blank" class="btn btn-info" style='margin:auto; display: block; width:50%;'>Accept Assignment</a>
```
<br>
...
As a bit of an example, below is Jed's creation, which uses purely lines, circles, rectangles, and a label:
