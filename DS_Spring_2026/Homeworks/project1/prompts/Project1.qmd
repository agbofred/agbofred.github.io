...
subtitle: "Due: February  04, 2026 at 10:00 PM"
format:
  html:
    theme:
      light: 
...
```{=html}
<a href='https://classroom.github.com/a/t0Xp96QQ' target="_blank" class="btn btn-info" style='margin:auto; display: block; width:50%;'>Accept Mini Project</a>
```
<br>
...
You must choose one of Python's built-in collections (`list` or `dict`) to store the items inside your Bag class. For example, if you choose a list, your Bag object would have a member variable like `items = []`. If you choose a dict, you might have `counts = {}`.
...
In a separate text file named `analysis.txt`, you must provide the following:
