...
subtitle: "Due: March  11, 2026 at 10:00 PM"
format:
  html:
    theme:
      light: 
...
```{=html}
<a href='https://classroom.github.com/a/89VijMsT' target="_blank" class="btn btn-info" style='margin:auto; display: block; width:50%;'>Accept Mini Project</a>
```
<br>
...
## Extra Points (Optional 10 points)

- Allow the user to specify the number of disks. (**5 points**)
- Add a method to reset the puzzle. (**3 points**)
- Add error handling for invalid moves. (**2 points**)
