---
title: "AI 380: Course Syllabus"
subtitle: "Human-AI Interaction · Fall 2026"
...
| **Website** | [fredagbo.com](https://fredagbo.com/) |
| **Google Scholar** | [View Publications](https://scholar.google.com/citations?hl=en&user=mSqmwdgAAAAJ) |
...
<!-- | Title | Author | Access |
|---|---|---|
| *Designing the User Interface* (6th Ed.) | Shneiderman et al. | Recommended purchase or library |
| *Human-Computer Interaction* (3rd Ed.) | Dix, Finlay, Abowd, Beale | Library / PDF |
| *The Design of Everyday Things* | Don Norman | Library / PDF | -->

::: {.callout-note}
Weekly readings will be provided as PDFs or links via Canvas. No single textbook purchase is required. See the [Schedule](schedule.md) page for the complete list of assigned weekly materials.
:::
...
<!-- | **Otter.ai / Rev.ai** | Transcription for user studies | Free tier | -->
...
This course centers on **two major group project** requiring 2–3 members per group. The project works students through the full UX design process — from need-finding through usability evaluation — within a chosen HCI genre. There will be four formal deliverables (see [Project](project.md) for full details including deliverables, grading rubrics, and due dates):

<!-- | Deliverable | Description | Weight |
|---|---|---|
| **Project Setup & Pitching** | Team agreement, problem statement, POV, initial pitch | 15% |
| **Mid-term Lo-Fi Presentation** | Need-finding, low-fidelity prototype, concept demo | 15% |
| **Hi-Fi System & Evaluation Plan** | Interactive prototype, heuristic evaluation, user study plan | 15% |
| **Final Report & Presentation** | Complete report, public demo, peer assessment | 15% | -->
...
The procedure:
1. Email the instructor **before** the deadline explaining the situation
2. Receive a written reply confirming any extension
3. No extension is valid without a written reply
...
Penalties may range from a grade reduction on an assignment to failing the course. 
An instructor can also involve the Office of the Dean of the School of Computing and Information Sciences for further action. For further information, read the [School of Computing and Information Science students handbook](https://catalog.willamette.edu/policies/scis) and also see the [Willamette Academic Integrity Policy](https://catalog.willamette.edu/policies/university#academic-integrity-policy) for full details.
...
- **Accessible Education Services** — Smullin 155  
- Phone: 503-370-6737  
- Email: [Accessible-info@willamette.edu](mailto:Accessible-info@willamette.edu)
...
- Confidential Advocate: [confidential-advocate@willamette.edu](mailto:confidential-advocate@willamette.edu)
- WUTalk (24-hr crisis line): **503-375-5353**
- Campus Safety: **503-370-6911**

## SOAR Center

The [SOAR Center](https://www.willamette.edu/go/soar) provides free, confidential access to food, toiletries, clothing, textbooks, and scholarly resources for all Willamette students (Putnam UC, 3rd floor).
...
**Olivia Muñoz** — [omunoz@willamette.edu](mailto:omunoz@willamette.edu) · 3rd Floor UC · 503-370-6447

---

# Semester Calendar Overview

For the detailed week-by-week schedule including all readings and due dates, see the [Schedule](schedule.md) page.
...
<!-- | Dec 5 | Final Reflection Essay Due |
