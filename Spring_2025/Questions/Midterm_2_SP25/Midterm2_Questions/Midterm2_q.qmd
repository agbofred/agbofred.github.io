...
```{=html}
<a href='https://classroom.github.com/a/5XqrfOHE' target="_blank" class="btn btn-info" style='margin:auto; display: block; width:50%;'>Accept Midterm 2 Exam</a>
```
<br>
...
![](./images/Emoji_gif.gif){width=650}
