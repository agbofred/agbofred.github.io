...
This second midterm exam contains 1 question that consist of topics already covered in the class (Functions, Graphics, and Interactive Programs). This is a programming problem, hence, use Visual Studio Code to write and test your program. Ensure that your program is well documented.
