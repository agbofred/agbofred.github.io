...
```{=html}
<a href='https://classroom.github.com/a/CaFFMwXg' target="_blank" class="btn btn-success" style='margin:auto; display: block; width:50%;'>Accept Project</a>
```
<br>
