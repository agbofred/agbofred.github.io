...
```{=html}
<a href='https://classroom.github.com/a/uTATaWCd' target="_blank" class="btn btn-success" style='margin:auto; display: block; width:50%;'>Accept Project</a>
```
<br>
...
![Graphical depiction of rotating an image array 90&deg; counter-clockwise (left). Note that what was previously the last column is now the first row, and what was the first row is now the first column.](rotation_image.svg){#fig-ImageRotation width=550}
