...
There are just two questions in this problem set. Question 1 is about working with coordinate positions in PGL, while Question 2 introduces you to mouse-driven events in PGL. Files are provided in the starting template linked before for all three questions. Make sure you fill out the top metadata on each problem please!
