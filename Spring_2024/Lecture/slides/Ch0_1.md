...
- Things to do:
	- Access the course webpage on Canvas at here!
	- Lecture slides can also be accessed from my personal website at here
...
- Watch the video to study how to setup your computer with tools needed for this class from the link () 
- Homework
	- Problem Set 1 will be posted before the end of this week
