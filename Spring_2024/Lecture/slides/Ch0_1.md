...
- Things to do:
	...
	- Class communication and announcements will be on Canvas and ***Discord Server***. 
		<!--- - Invitation to ***Join the Discord*** will be available this week-->
...
- Submissions of _both_ will be handled through Github Classroom
	- Learn how to do this from Jed's [videos](https://willamette.edu/~jjrembold/classes/cs151/software_setup/). Or meet me during my office hours if something is not working as expected!
