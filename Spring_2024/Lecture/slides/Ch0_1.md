...
- Things to do:
	- Access the course webpage on Canvas at [here!] (https://willamette.instructure.com/courses/4754)
	- Read over the full syllabus carefully
	- Join the class [Discord server](https://discord.gg/G3nphsct) for ease of communication and announcements 
	- Fill out the section availability form <TBD>
	- Fill out this CS/DS/Math Program Assessment Survey <TBD>
- Bring phone or computer to the class for polling questions in the future
- Watch and follow the videos and instructions prepared by __Professor Jed__ to setup your computer with tools needed in this class. [Here!](https://willamette.edu/~jjrembold/classes/cs151/software_setup/) 
- Homework
	- Problem Set 1 will be posted before the end of this week and due __Jan 29 at 10pm__
...
- Submissions of _both_ will be handled through Github Classroom
	- Learning how to do this from Jed's video or in class
...
- Just two this semester:
	- Midterm on Fed 23 (in-class, use of computer, partially open)
	- Final on March 22 (take-home, use computer, totally open)
...
- I have had much better luck recently channeling class communication (announcements, questions, answers, etc) through a class Discord server and on Canvas
	- Invite instructions are posted on the main Canvas class announcements page
